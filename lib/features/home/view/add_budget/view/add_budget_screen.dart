        ...
        builder: (context, child) {
          ...
          return Scaffold(
              appBar: AppBar(
                ...
                actions: [
                  context.read<BudgetProvider>().isLast
                      ? TextButton(
                          isSemanticButton: context
                              .read<BudgetProvider>()
                          ...
                          onPressed: () {
                            if (context
                              ...
                              if (model.amountBudget > 0) {
                                ...
                                context.maybePop();
                                context.pushRoute(SuccessfullyRoute(
                                    subtitle: S.of(context).budget_added));
                              }
                            } else {
              ...
              body: child,
              bottomNavigationBar: context.read<BudgetProvider>().isLast
                  ? null
                  : Padding(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          if (context.read<BudgetProvider>().isSumm) {
                            if (tabsRouter.activeIndex + 1 <= 2) {
                              tabsRouter
                                  .setActiveIndex(tabsRouter.activeIndex + 1);
                              final index = tabsRouter.activeIndex + 1;
                              context.read<ItemsToBudgetCubit>().setEmit(
                                  context,
                                  index: index,
                                  controller: monthlyBudget);
                            }
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor: context.read<BudgetProvider>().isSumm
